...
class ActionLayer(BaseActionLayer):
    ...
    def _competing_needs(self, actionA, actionB):
        ...
        """
        # TODO: implement this function
        for pre_cond_A in actionA.preconditions:
            for pre_cond_B in actionB.preconditions:
                if self.parent_layer.is_mutex(pre_cond_A, pre_cond_B):
                    return True
        return False
...
class LiteralLayer(BaseLiteralLayer):
    ...
    def _inconsistent_support(self, literalA, literalB):
        ...
        """
        # TODO: implement this function
        litA_parent_actions = self.parents[literalA]
        litB_parent_actions = self.parents[literalB]
